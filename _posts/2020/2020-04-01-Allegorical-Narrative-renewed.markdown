...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[1] }}');width:32%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[2] }}');width:32%;">
        <img src="{{ page.image-post[2] }}" alt="Placeholder" height="100%"/>
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[3] }}');width:32%;">
      </figure>
  </div>
</div>
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[7] }}');width:32%;">
        <img src="{{ page.image-post[7] }}" alt="Placeholder" height="100%"/>
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[8] }}');width:32%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[9] }}');width:32%;">
      </figure>
  </div>
</div>
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[10] }}');width:32%;">
        <img src="{{ page.image-post[10] }}" alt="Placeholder" height="100%"/>
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[11] }}');width:32%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[12] }}');width:32%;">
      </figure>
  </div>
</div>
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[13] }}');width:32%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[14] }}');width:32%;">
        <img src="{{ page.image-post[14] }}" alt="Placeholder" height="100%"/>
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[15] }}');width:32%;">
      </figure>
  </div>
</div>
