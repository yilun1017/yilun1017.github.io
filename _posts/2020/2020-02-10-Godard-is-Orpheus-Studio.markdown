...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      ...
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[4] }}');width:48%;">
          <img src="{{ page.image-post[4] }}" alt="Placeholder" height="100%"/>
      </figure>
  </div>
</div>
<figcaption>Jean-Luc Godard，“Le Studio d’Orphée”，Fondazione Prada, Milano，Photo/Foto: Agostino Osio – Alto Piano Courtesy Fondazione Prada</figcaption>
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[5] }}');width:48%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[6] }}');width:48%;">
        <img src="{{ page.image-post[6] }}" alt="Placeholder" height="100%"/>
      </figure>
  </div>
</div>
<figcaption>Jean-Luc Godard，“Le Studio d’Orphée”，Fondazione Prada, Milano，Photo/Foto: Agostino Osio – Alto Piano Courtesy Fondazione Prada</figcaption>
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[10] }}');width:48%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[11] }}');width:48%;">
...
<div class="crop-fig-div" >
    <div class="crop-fig-div__img">
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[12] }}');width:39%;">
      </figure>
      <figure class="crop-fig" style="background-image: url('{{ page.image-post[13] }}');width:59%;">
