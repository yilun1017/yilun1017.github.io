...
<figure class="nav-fig">
  <figure style="width:50%; height:700px; margin:5px; overflow:hidden">
...
<figure class="nav-fig">
  <figure style="width:50%; height:500px; margin:5px; overflow:hidden">
...
<figure class="nav-fig">
  <figure style="width:50%; height:500px; margin:5px; overflow:hidden">
    <img src="{{ page.image-post[5] }}" alt="Placeholder" height="100%"/>
  </figure>
  <figure style="width:50%; height:500px; margin:5px; overflow:hidden">
...
<figure class="nav-fig">
  <figure style="width:30%; height:200px; margin:5px; overflow:hidden">
  ...
  <figure style="width:30%; height:200px; margin:5px; overflow:hidden">
    <img src="{{ page.image-post[9] }}" alt="Placeholder" height="100%"/>
  </figure>
</figure>
<figcaption>Jean-Luc Godard，“Le Studio d’Orphée”，Fondazione Prada, Milano，Photo/Foto: Agostino Osio – Alto Piano Courtesy Fondazione Prada</figcaption>
...
<figure class="nav-fig">
  <figure style="height:400px; margin:5px; overflow:hidden">
